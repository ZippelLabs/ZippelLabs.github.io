...
app.innerHTML = `
  <!-- Audits Banner -->
  <div class="audits-banner">
    <div class="audits-inner">
      <span class="audits-label">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
          <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/>
        </svg>
        Security Research & Audits
      </span>
      <div class="audits-tags">
        <a href="/audits.html" class="audit-tag">ZKPs</a>
        <a href="/audits.html" class="audit-tag">MPC</a>
        <a href="/audits.html" class="audit-tag">FHE</a>
      </div>
      <a href="/audits.html" class="audits-cta">
        Request Audit
